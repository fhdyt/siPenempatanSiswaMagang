...
$query  = "SELECT * FROM SISWA AS S, JURUSAN AS J, LOCATION AS L, PERMOHONAN AS P WHERE P.SISWA_ID=S.SISWA_ID AND S.JURUSAN_ID=J.JURUSAN_ID AND P.LOCATION_ID=L.LOCATION_ID AND L.LOCATION_ID='".$LOCATION_ID."' AND P.PERMOHONAN_STATUS='A' ";
